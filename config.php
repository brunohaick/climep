...
$ArrVacina = array(
	...
	"9"=>array(
		"TP Master","Herpes Zoster","Injeção","Aplicação de Synagis","HIV I e II","TP Plus","Imunodeficiência","TP Ampliado","T. Orelhinha","Teste do Olhinho",
		...
		"TCA Imunidade Celular", "Brinco com Aplicador", "Brinco Aplicação", "Brinco (Venda)"
	),
);
