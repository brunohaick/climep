...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 3, utf8_decode('CLIMEP - RELATÓRIO DE FATURAS'), 0, 0, 'L', false);
...
//        $this->Cell(18, 3, utf8_decode('TIPO'), 1, 0, 'L', false);
//        $this->AfastaCell(1);
        $this->Cell(18, 3, utf8_decode('FATURA'), 0, 0, 'L', false);
        $this->AfastaCell(1);
        $this->Cell(18, 3, utf8_decode('CLIENTE'), 0, 0, 'L', false);
        $this->AfastaCell(20);
    ...
    function relatorioFaturas() {
        ...
        foreach ($lista as $i => $l) {
            ...
            $this->AfastaCell(1);
            $this->Cell(37, 3, encurtar2(utf8_decode($l['nome_cliente']), 21), 0, 0, 'L', false);
            $this->AfastaCell(1);
            $this->Cell(37, 3, encurtar2(utf8_decode($l['nome_empresa']),20), 0, 0, 'L', false);
            $this->AfastaCell(1);
            $this->Cell(18, 3, utf8_decode($l['data_lancamento']), 0, 0, 'L', false);
            $this->AfastaCell(2);
            $this->Cell(18, 3, utf8_decode($l['data_emissao']), 0, 0, 'L', false);
            $this->AfastaCell(1);
            $this->Cell(21, 3, number_format($l['total'], 2, ',', ''), 0, 0, 'R', false);
            $this->AfastaCell(1);
            $this->Cell(10, 3, number_format(($l['total'] * 100)/$total, 2, ',', ''), 0, 0, 'R', false);
            $this->AfastaCell(1);
...
//        $this->AfastaCell(2);
        ...
        $this->Cell(18, 3, '', 0, 0, 'L', false);
        $this->AfastaCell(1);
        $this->Cell(37, 3, 'Total', 0, 0, 'L', false);
        $this->AfastaCell(2);
        $this->Cell(37, 3, '', 0, 0, 'L', false);
        $this->Cell(18, 3, '', 0, 0, 'L', false);
        $this->AfastaCell(2);
        $this->Cell(18, 3, '', 0, 0, 'L', false);
        $this->AfastaCell(1);
        $this->Cell(21, 3, number_format($totalgeral, 2, ',', ''), 0, 0, 'R', false);
        $this->AfastaCell(1);
...
$dados = $_SESSION['listaFaturas'];
//die(print_r($dados));
$pdf = new PDF();
$pdf->SetMargins(4, 2, 4);
$pdf->relatorioFaturas();
