...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(0, 3, utf8_decode('CLIMEP - RELATÓRIO CONTABIL ( 6 - Vacinas Pagas )'), 0, 0, 'L', false);
	...
	function relatorioVacinasPagas() {
		$this->SetFont('Courier', 'B', 8);
...
$dados = $_SESSION['Mapavacinaspagas'];
$ncol = 0;
$ncol = ((count($dados[0]['cabecalho'])) - 2) / 3;
$pdf = new PDF();
$pdf->SetMargins(4, 2, 4);
$pdf->relatorioVacinasPagas();
$pdf->Output("relatorio_vacinaspagas.pdf", "I");
