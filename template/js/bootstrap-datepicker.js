...
!function( $ ) {
	...
	$(function(){
		...
		$('#hist-entrada-data-inicio').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#hist-entrada-data-fim').datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#data-inicio-resumo-caixa').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#data-fim-resumo-caixa').datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#dl-dataInicio').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#dl-dataFim').datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#mc-dataInicio').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#mc-dataFim').datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#ue-dataInicio').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#ue-dataFim').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#dep-nascimento').datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#he-dataInicio').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#he-dataFim').datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#nf-data-emissao').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#nf-data-entrada').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#nf-selc-vencto').datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$("input[name='guia-tiss-data_autorizacao']").datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$("input[name='guia-tiss-data_validade_carteira']").datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$("input[name='guia-tiss-consulta-data_autorizacao']").datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$("input[name='guia-tiss-consulta-data_validade_carteira']").datepicker({
			format: 'dd/mm/yyyy'
		});
	});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#linguinha-reavaliacao').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#olhinho-reteste-data').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#O1-reavaliacao').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#O2-reavaliacao').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#data-retorno-agenda').datepicker({
			format: 'dd/mm/yyyy'
		});
	...
	$(function(){
		window.prettyPrint && prettyPrint();
		$('#ficha-vacina-data').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#vaci-nasc').datepicker({
			format: 'dd/mm/yyyy'
		});
		$('#consultafinal').datepicker({
			format: 'yyyy-mm-dd'
		});
                $('#consultaInicial').datepicker({
			format: 'yyyy-mm-dd'
		});
	});
